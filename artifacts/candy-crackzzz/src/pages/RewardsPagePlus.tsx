...
import { Gift, LogOut, Search, Trophy, Users, Copy, Clock3, Sparkles } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground font-bold max-w-2xl mx-auto">Track your points, pending rewards, referral code, and recent activity using the phone number tied to your orders.</p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-card border border-border rounded-3xl p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    <div className="bg-background border border-border rounded-2xl p-4"><div className="font-black">Friend bonus</div><div className="text-muted-foreground mt-1">{settings.referralReferredCustomerBonusPoints} bonus points on the first eligible completed order.</div></div>
